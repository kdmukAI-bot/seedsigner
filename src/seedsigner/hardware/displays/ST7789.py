...
class ST7789(BaseDisplayDriver):
    ...
    def init(self):
        ...
        # VCOMS/power/gamma below mirror st7789_mpy.py's tone curve, which renders
        # anti-aliased text more legibly on the 240x240 panel. Tradeoff: slightly
        # washed-out orange highlight + brighter gray fills (tune UI colors if needed).
        self.command(0xBB)
        self.data(0x28)

...
# GUIConstants / icon constants now live in the PIL-free gui.constants module so the View
# layer can import them without pulling in PIL. Re-exported here for back-compat.
from seedsigner.gui.constants import GUIConstants, FontAwesomeIconConstants, SeedSignerIconConstants
